...
import com.rowanmcalpin.nextftc.hardware.positionable.SetPositions
 ...
 * @author BeepBot99
 */
open class SetPositions(vararg val states: PositionableState) : InstantCommand({
    states.forEach {
        it.positionable.position = it.position
    }
})
